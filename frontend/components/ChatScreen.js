...
const styles = StyleSheet.create({
  ...
  myMessageBubble: { backgroundColor: '#2563EB', borderBottomRightRadius: 4 },
  theirMessageBubble: { backgroundColor: '#fff', borderBottomLeftRadius: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  ...
  readReceipt: { fontSize: 11, color: 'rgba(255,255,255,0.65)' },
  typingIndicator: { paddingHorizontal: 20, paddingVertical: 8, backgroundColor: '#F1F5F9' },
  typingText: { fontSize: 13, fontStyle: 'italic', color: '#94A3B8' },
  inputContainer: {
  ...
  input: {
    ...
    color: '#1E293B', maxHeight: 100, borderWidth: 1.5, borderColor: '#E2E8F0',
  },
  sendButton: {
  ...
  modalContent: { backgroundColor: '#fff', borderRadius: 20, padding: 24, width: '80%', maxWidth: 360 },
  modalTitle: { fontSize: 18, fontWeight: '700', color: '#0F172A', marginBottom: 8 },
  modalText: { fontSize: 14, color: '#64748B', marginBottom: 20 },
  modalButton: { backgroundColor: '#2563EB', padding: 14, borderRadius: 12, alignItems: 'center', marginBottom: 10 },
  modalButtonDanger: { backgroundColor: '#DC2626' },
  modalButtonCancel: { backgroundColor: 'transparent', borderWidth: 1.5, borderColor: '#E2E8F0' },
  modalButtonText: { color: '#fff', fontSize: 15, fontWeight: '600' },
  modalButtonCancelText: { color: '#64748B' },
});